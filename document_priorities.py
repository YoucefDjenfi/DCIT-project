...
#
# Priority tier mapping using EXACT filenames as they appear on disk.
# These were verified against the git pull output — do not rename files
# without updating this mapping.
#
# Priority 1 — Core Algerian cyber law (searched first, every query)
# Priority 2 — Supporting law & international context
# Priority 3 — Background / supplementary (last resort)
...
DOCUMENT_PRIORITIES: dict[str, int] = {
    ...
    # ── Priority 2: Supporting domestic law ───────────────────────────────────
...
# Files to exclude from ingestion entirely (duplicates, scanned, irrelevant)
SKIP_FILES: set[str] = {
